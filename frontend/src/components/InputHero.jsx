...
export default function InputHero({ 
  ...
  const handleSubmit = (e) => {
    ...
    if (activeTab === 'image' && selectedFile) {
      onAnalyze({ file: selectedFile, agent: 'ocr' });
      return;
    }
      ...
      <div className="relative z-10 rounded-2xl bg-[#0E1626]/90 border border-slate-700/80 shadow-2xl p-4 sm:p-6 backdrop-blur-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              ...
              {previewUrl ? (
                <div className="flex flex-col sm:flex-row items-center gap-4 text-left">
                  <div className="relative w-28 h-28 rounded-lg overflow-hidden border border-slate-700 flex-shrink-0 bg-black">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-xs text-emerald-400 flex items-center gap-1 font-medium">
                      ...
                      Ready for Optical Character Recognition (OCR) & AI Scan
                    </p>
                  </div>
                </div>
              ) : (
                <div className="space-y-2 py-4">
                  ...
                  <div className="text-sm font-medium text-slate-200">
                    Drag & drop WhatsApp, SMS, or Email screenshot
                  </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={isAnalyzing || (activeTab === 'image' ? !selectedFile : !inputText.trim() && !inputUrl.trim())}
              className={`w-full sm:w-auto px-8 py-3.5 rounded-xl font-bold text-sm text-white flex items-center justify-center gap-2.5 transition-all shadow-xl ${
                isAnalyzing
                  ...
                  : (activeTab === 'image' ? selectedFile : inputText.trim() || inputUrl.trim())
